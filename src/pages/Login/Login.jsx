        ...
        <div>
            ...
            <div id='login'>
                ...
                <Form className=' d-flex flex-column  align-items-center' onSubmit={handleLogin} id='login-form'>
                    ...
                    <input onChange={(e) => setEmail(e.target.value)} onFocus={(e) => e.target.placeholder = ""} type='email' onBlur={(e) => e.target.placeholder = 'Name'} id='form-element' type="text" name="" placeholder='Email' />

                    <input onChange={(e) => setPassword(e.target.value)} onBlur={(e) => e.target.placeholder = 'Password'} type='password' onFocus={(e) => e.target.placeholder = ""} id='form-element' type="password" name="" placeholder='Password' />
